...
function initMap()        // initMap fxn has two works- 1st to make map visible and second to mark the position on map.
 {
  var mapOptions = {zoom: 14,center: { lat:26.8454, lng:75.7675}};       // centre of map and its zoom size is stored in mapOptions variable.
  ...
  var marker = new google.maps.Marker({position: { lat:26.8454 , lng:75.7675 } ,  map: map });      //this sets the marker
